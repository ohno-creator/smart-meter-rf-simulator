...
export default function ProSimulator() {
  ...
  return (
    <div className="app">
      ...
      <div className="wrap">
        <div className="head">
          <div><div className="eyebrow">PRO MODE</div><h1 className="title">RFリンク詳細評価（プロ向け）</h1><div className="sub">損失レンジ・偏波・金属遮蔽・浸水・2波ヌルに加え、内蔵/外部/防水アンテナ構成を比較。現地RSSIログの照合も可能</div></div>
          <div className="row">
