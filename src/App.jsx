...
export default function App() {
  ...
  const envLossNominal = env.loss + place.loss + floodNom + addLoss.v + totalPolLoss + bodyLoss.v;
  const envLossWorst = env.lossMax + place.lossMax + floodWorst + addLoss.v + totalPolLoss + bodyLoss.v;
  ...
  ].sort((a, b) => b.value - a.value), [place.loss, env.loss, floodNom, totalPolLoss, bodyLoss.v, addLoss.v, txLoss, rxLoss]);
